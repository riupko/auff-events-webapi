namespace AuffEventsMobileService.Migrations
{
    ...
    public partial class Initial : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        EntryFormId = c.String(maxLength: 128),
                ...
                c => new
                    {
                        ...
                        DateEntryStop = c.DateTime(nullable: false),
        ...
        {
            DropForeignKey("dbo.EntryFormMembers", "TeamMemberId", "dbo.TeamMembers");
            DropForeignKey("dbo.EntryFormMembers", "EntryFormId", "dbo.EntryForms");
            ...
            DropIndex("dbo.TeamMembers", new[] { "CreatedAt" });
            ...
            DropIndex("dbo.EntryForms", new[] { "CreatedAt" });
            DropIndex("dbo.EntryForms", new[] { "TeamId" });
            DropIndex("dbo.EntryForms", new[] { "EventId" });
            DropIndex("dbo.EntryFormMembers", new[] { "CreatedAt" });
            DropIndex("dbo.EntryFormMembers", new[] { "TeamMemberId" });
            DropIndex("dbo.EntryFormMembers", new[] { "EntryFormId" });
            ...
            DropTable("dbo.EntryFormMembers",
                removedColumnAnnotations: new Dictionary<string, IDictionary<string, object>>
                {
                    {
                        "CreatedAt",
